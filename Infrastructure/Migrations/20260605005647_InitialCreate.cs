        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FullName = table.Column<string>(type: "TEXT", maxLength: 201, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnrollmentYearValue = table.Column<int>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Students_AcademicYear_EnrollmentYearId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Courses_AcademicYear_AcademicYearId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "2301D884-221A-4E7D-B509-0113DCC043E1", null, "Rola administratora systemu", "Administrator", "ADMINISTRATOR" },
                    { "7D9B7113-A8F8-4035-99A7-A20DD400F6A3", null, "Rola pracownika dziekanatu", "DeaneryWorker", "DEANERYWORKER" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "B22698B8-42A2-4115-9631-1C2D1E2AC5F7", 0, "a596707a-e710-41ce-90a5-3a8a25a835f1", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "IT", "admin@wsei.edu.pl", true, "Admin", "Admin Główny", null, "Główny", false, null, "ADMIN@WSEI.EDU.PL", "ADMIN", "AQAAAAIAAYagAAAAEE+xC98O3NWJHBCbhYq+0IS5ihK2MmOPAHL0eM3ivgrSZqzgkbyXkCGvms+kEBV5+Q==", null, false, "A74268D7-17D3-4F8A-98CB-5A2BBEE2C741", "Active", false, "admin" },
                    { "E244194A-4254-434A-8E9A-912784462A05", 0, "5fb05a8f-2873-45d3-a6d9-d07413316e25", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Dziekanat", "jan.kowalski@wsei.edu.pl", true, "Jan", "Jan Kowalski", null, "Kowalski", false, null, "JAN.KOWALSKI@WSEI.EDU.PL", "JANKOWALSKI", "AQAAAAIAAYagAAAAEAjM5sfS83ROpTUAZXEF0e7gglYry7dkP/zoGrpnPJX6SOvxODYzNEkkabTk3IGalQ==", null, false, "B85379E8-28E4-5G9B-A9DC-6B3CCFF3D852", "Active", false, "jankowalski" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { "7D9B7113-A8F8-4035-99A7-A20DD400F6A3", "E244194A-4254-434A-8E9A-912784462A05" }
                });
